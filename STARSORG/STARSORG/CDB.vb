...
Public Class CDB
    Public Function OpenDB() As Boolean
        ...
        If objSQLConn Is Nothing Then 'need to instantiate connection object
            Try
                objSQLConn = New SqlConnection(gstrConn)
                objSQLConn.Open()
                blnResult = True
            Catch exOpenConnError As Exception
                MessageBox.Show("Cannot open databse: " & exOpenConnError.ToString, "Connection error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                blnResult = False
    ...
    Public Function GetSingleValueFromSP(ByVal strSP As String, ByRef params As ArrayList) As String
        ...
        If Not sqlDR Is Nothing Then 'got a data reader
            If sqlDR.Read Then 'there is data
